...
public class FileAdapter extends RecyclerView.Adapter<FileViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.musicfile.FileViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.example.musicfile.FileViewHolder(LayoutInflater.from(context).inflate(R.layout.file_container,parent,false));

    }

    @Override
    public void onBindViewHolder(@NonNull com.example.musicfile.FileViewHolder holder, int position) {
